...
export const androidReleaseUrl = 'https://github.com/LHT02/KIGTTS/releases/tag/APP0.1.7';
export const androidApkUrl = 'https://github.com/LHT02/KIGTTS/releases/download/APP0.1.7/app-release.apk';
...
export const featureSlides = [
  {
    ...
    brief: '不光能看好用，还能发声。',
    summary:
      '专为 Kigurumi 玩家打造的字幕工具。自带 TTS 功能与音量增益，甚至支持语音识别。把语音识别、快捷文本、TTS 朗读和大字幕预览放在同一个界面里，减少现场沟通的来回切换。',
